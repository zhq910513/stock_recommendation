...
# https://data.10jqka.com.cn/dataapi/limit_up/limit_up_pool?page=1&limit=15&field=199112,10,9001,330323,330324,330325,9002,330329,133971,133970,1968584,3475914,9003,9004&filter=HS&order_field=330324&order_type=0&date=20220628&_=1655791453890
...
# mongo collections
lianbang = 'zhangting'  # 涨停


def get_zhangting_stocks():
    ...
    try:
        ...
        if req.status_code == 200:
            if req.json().get('status_code') == 0 and req.json().get('status_msg') == 'success':
                ...
                print(f'---------- {date} 涨停 {len(all_data)} 只 ----------')
